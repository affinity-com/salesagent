...
## [2.0.0](https://github.com/affinity-com/salesagent/compare/v1.7.0...v2.0.0) (2026-06-18)
...
* **bdd:** render UC-011/019/026 feature files to AdCP 3.1 (merge mode) ([4e9c183](https://github.com/affinity-com/salesagent/commit/4e9c183ec2dec1c34968333ee970def7b28b4e7b))
...
* **ci:** parallel BDD CI shards with merged coverage (stacked on PR3) ([#1379](https://github.com/affinity-com/salesagent/issues/1379)) ([19d3efd](https://github.com/affinity-com/salesagent/commit/19d3efd5499defa5df24714b3ea283a3e00553d1))
...
* **idempotency:** success-cache replay (PR 1 after error-emission) ([#1312](https://github.com/affinity-com/salesagent/issues/1312)) ([b94ab97](https://github.com/affinity-com/salesagent/commit/b94ab979b89bdd25f322267167513b4a08025b61))
...
* add explicit strict=False to pairwise zip() in uc002 (B905) ([f89201c](https://github.com/affinity-com/salesagent/commit/f89201cbef74749803e1ecc13158fd86c6e7969e))
...
* **agent-db:** resolve PROJECT_DIR to the worktree root, not the skill dir ([#1443](https://github.com/affinity-com/salesagent/issues/1443)) ([ad33521](https://github.com/affinity-com/salesagent/commit/ad335214cf8a13d24057bb7b8ab5a8b9451d38c6))
...
* **bdd:** add brand+op+sandbox account-resolution boundary branch ([67681ed](https://github.com/affinity-com/salesagent/commit/67681edc5258204c611a929f05ba8b09cbc8a1fe))
* **bdd:** add natural_key_sandbox account-resolution Given branch ([26540ea](https://github.com/affinity-com/salesagent/commit/26540eaf6910b4a5d40a95e77dfc8cae7326bc78))
* **bdd:** add reach_unit Given parser to stop status-column overflow ([9249071](https://github.com/affinity-com/salesagent/commit/924907133919aee21875ff60f5769391b5bfd133))
* **bdd:** parse space-separated status_filter so v3.1 values reach _impl ([0a9612c](https://github.com/affinity-com/salesagent/commit/0a9612cc4a6c7247f4a0dd323d1570da09274aa5))
* **bdd:** resolve 'media_buy_ids provided' boundary to an IDs request ([ed9633f](https://github.com/affinity-com/salesagent/commit/ed9633fc51ae2431e1cab52c25f094db8c52949f))
* **bdd:** revert too-broad request_params parser; xfail pending_* status filters ([2073994](https://github.com/affinity-com/salesagent/commit/2073994a98138d8b186bd4df36f535971fcdfca6))
...
* **ci:** bump authlib 1.6.11 -&gt; 1.7.2 for PYSEC-2026-188 ([7399a77](https://github.com/affinity-com/salesagent/commit/7399a772dd28ef1005155ab66ea251a0aad62825))
* **ci:** bump uv 0.11.6 -&gt; 0.11.15 for GHSA-4gg8-gxpx-9rph ([#1375](https://github.com/affinity-com/salesagent/issues/1375)) ([e4e8b4d](https://github.com/affinity-com/salesagent/commit/e4e8b4d6804f1d6a616c206a014041bdcbf7cc05))
* **ci:** cache creative agent build with buildx GHA cache ([#1189](https://github.com/affinity-com/salesagent/issues/1189)) ([#1437](https://github.com/affinity-com/salesagent/issues/1437)) ([c1f0ab1](https://github.com/affinity-com/salesagent/commit/c1f0ab13cb11399940ec9d1e5d8a6462489105b5))
* **ci:** format compile_bdd.py and bump aiohttp 3.13.5 -&gt; 3.14.0 ([081d3e4](https://github.com/affinity-com/salesagent/commit/081d3e4d366368004b31e8f62d573295092356cd))
* **ci:** operational helper layering and guard completeness (PR 3-3 of [#1234](https://github.com/affinity-com/salesagent/issues/1234)) ([#1424](https://github.com/affinity-com/salesagent/issues/1424)) ([fa4221b](https://github.com/affinity-com/salesagent/commit/fa4221bc198f89f515d5cbe01aec5b681cea99de))
...
* **deps:** bump aiohttp + authlib for CVE-2026-34993 / PYSEC-2026-188 ([#1385](https://github.com/affinity-com/salesagent/issues/1385)) ([a54b906](https://github.com/affinity-com/salesagent/commit/a54b906495b405feca2507206a6e095ceb42d186))
...
* restore AdCPValidationError import lost in merge auto-resolution ([af39e87](https://github.com/affinity-com/salesagent/commit/af39e8739fed704f6b63681ded4c6e76b242e2a9))
...
* **schema:** align GetProductsRequest push notification config ([#1393](https://github.com/affinity-com/salesagent/issues/1393)) ([7cb7e00](https://github.com/affinity-com/salesagent/commit/7cb7e00bb42325c7b88034a5f8fa953045e3543c))
...
* strengthen 131 weak BDD Then step assertions with production-value checks ([78be790](https://github.com/affinity-com/salesagent/commit/78be790e373b80e292f94f44a250be9592b44601))
...
* **test-harness:** implement MediaBuyCreateEnv's missing setup helpers ([#1382](https://github.com/affinity-com/salesagent/issues/1382)) ([ac1e97a](https://github.com/affinity-com/salesagent/commit/ac1e97aaef1dff1c7131cb94b479b0e1ae04db1b))
* **test:** read step files as UTF-8 in bdd-no-direct-call-impl guard ([#1431](https://github.com/affinity-com/salesagent/issues/1431)) ([246d85c](https://github.com/affinity-com/salesagent/commit/246d85cfebff04345f1687d3b993593fa23e60cb))
...
* use shared _get_error_message() instead of str(error).lower() in uc004 (wdge) ([1629369](https://github.com/affinity-com/salesagent/commit/16293695580a6095b14700709d692f142ac6bd90))
...
* add _require/_require_error helpers + guard ctx['error'] subscripts in BDD Then steps (qlsx-a) ([bbbcda5](https://github.com/affinity-com/salesagent/commit/bbbcda5e8a281aa407f494b10b9e1bded031d915))
...
* consolidate account reference coercion ([#1439](https://github.com/affinity-com/salesagent/issues/1439)) ([aa02c54](https://github.com/affinity-com/salesagent/commit/aa02c54fc1717651ac35e797d313137d44d489c5))
...
* extract _assert_exponential_backoff helper in uc004_delivery (vpgh) ([d2f1474](https://github.com/affinity-com/salesagent/commit/d2f14740f23405d47d067a10e8c45aa9d73fdc8c))
* extract _assert_format_check_outcome helper in uc006_sync_creatives (ftmy) ([c5ef5c1](https://github.com/affinity-com/salesagent/commit/c5ef5c19e357aaa81f83476302d9b5a7f914e6d7))
* extract _get_assignment_from_db helper in uc006_sync_creatives (spug) ([9c2fc60](https://github.com/affinity-com/salesagent/commit/9c2fc60caae3d46fd91ed16748f78ef185d9bdb6))
...
* move then_webhook_notification to uc002 domain step file (aya0) ([c7a1527](https://github.com/affinity-com/salesagent/commit/c7a1527bad3f48fd62fcf92ca997dd103759940d))
* relocate pre-commit hooks to appropriate layers (PR 4 of [#1234](https://github.com/affinity-com/salesagent/issues/1234)) ([#1390](https://github.com/affinity-com/salesagent/issues/1390)) ([afbe8e8](https://github.com/affinity-com/salesagent/commit/afbe8e8a5c9c350969ff61d466d9507fd8d2c478))
